...
//
// `grey`, `dimgrey`, `darkgrey`, `darkslategrey`, `lightgrey`,
// `lightslategrey`, `slategrey` are the British-spelling aliases
// preserved upstream; they alias to the equivalent `gray` entries.
//
// The table is closed: SVG/CSS hasn't added a name in well over a
...
var svgColors = map[string]uint32{
	...
	// British-spelling aliases (preserved verbatim from tcell).
	"grey":           0x808080,
	"dimgrey":        0x696969,
	"darkgrey":       0xA9A9A9,
