...
// Key is the keystroke or sigil being advertised; Description is the
// one-line "what it does" the user reads. Two fields rather than a
// single pre-formatted string so a future renderer can chip the key
// the same way the help overlay does (see help.entry / chipText)
